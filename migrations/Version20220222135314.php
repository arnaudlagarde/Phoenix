...
final class Version20220222135314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE risk (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, identification_date DATETIME NOT NULL, resolution_date DATETIME NOT NULL, critical TINYINT(1) NOT NULL, probability VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
